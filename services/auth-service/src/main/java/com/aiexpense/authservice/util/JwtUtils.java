package com.aiexpense.authservice.util;
...
public class JwtUtils {
    ...
    public String generateAccessToken(Long userId, String username, String email) {
        ...
        return buildToken(claims, jwtExpirationMs);
    }
    ...
    public String generateRefreshToken(Long userId, String username) {
        ...
        return buildToken(claims, jwtRefreshExpirationMs);
    }
    ...
    private String buildToken(Map<String, Object> claims, Long expirationMs) {
        ...
        try {
            ...
            log.debug("Token built successfully");
            return token;
